...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="relative flex flex-col h-full bg-surface border-r border-border flex-shrink-0"
    >
      ...
      <div className="flex flex-col h-full w-full overflow-hidden">
        ...
        <div className="px-2 py-3 border-t border-border flex flex-col gap-2">
          {!collapsed && user && (
            <div className="px-3 py-2 rounded-xl bg-surface-raised">
      ...
      <button
        onClick={onToggle}
        className="absolute -right-3 top-14 w-6 h-6 rounded-full border border-border bg-surface flex items-center justify-center text-text-muted hover:text-white hover:border-border-bright transition-colors z-50"
